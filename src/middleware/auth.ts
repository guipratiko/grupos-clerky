...
// Nota: No microserviço, assumimos que o usuário já foi validado pelo backend principal
// Este middleware apenas verifica se o token existe
// A verificação de premium deve ser feita no backend principal antes do proxy
export const requirePremium = async (
  req: AuthRequest,
  res: Response,
  next: NextFunction
) => {
  // Como o backend principal já faz a verificação de premium antes de fazer proxy,
  // este middleware apenas passa adiante
  next();
};
